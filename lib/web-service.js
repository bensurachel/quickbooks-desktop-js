...
// };
  ...
  function WebServiceServer (xmlHandler,config,server){
     console.log("REACHED")
    qbXMLHandler = xmlHandler;
    var counter=0;
    var lastError = '';
            ...
            QBWebConnectorSvcSoap: {
                ...
                receiveResponseXML : function(args, callback) {
                    ...
                    if (hresult) {
                        ...
                        if ((typeof qbXMLHandler.handleResponse === "function")) {
                           console.log("HANDLE", config.userId)
                           console.log(qbXMLHandler)
                            qbXMLHandler.handleResponse(config.userId, response);
                            console.log("&&&&&&")
                        }
                        percentage = (!requestQueue.length) ? 100 : counter * 100 / requestQueue.length;
                        if (percentage >= 100) {
