 ...
 */
// this.webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.serverVersion = function (args, callback) {
//     var retVal = '0.2.0';
...
//  */
// this.webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.clientVersion = function(args, callback) {
//     var retVal = '';
...
// this.webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.authenticate = function(args, callback) {
    
//     var authReturn = [];
//     authReturn[0] = uuid.v1();
//     if (args.strUserName.trim() === "admin" && args.strPassword.trim() === "Pass123") {
...
//                     authReturn[1] = 'NONE';
//                 } else {
//                     authReturn[1] = "D:\\kloudio\\Files\\Kloudio01qbw.qbw";
//                 }
...
//  */
// this.webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.sendRequestXML = function(args, callback) {
//     var request = '';
...
//  */
// this.webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.receiveResponseXML = function(args, callback) {
...
//             qbXMLHandler.handleResponse(userId, response);
//         }
...
//  */
// this.webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.connectionError = function(args, callback) {
//     console.log("QB CONNECTION ERROR: " + args.message + ' (' + args.hresult + ')');
...
//  */
// this.webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.getLastError = function(args, callback) {
...
//  * @return 'OK'
//  */
// this.webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.closeConnection = function(args, callback) {
//     var retVal = 'OK';
...
// };
  ...
  function WebServiceServer (xmlHandler,config, rescallback){
     console.log("REACHED")
    qbXMLHandler = xmlHandler;
    var counter=0;
    var lastError = '';
        ...
        QBWebConnectorSvc: {
            QBWebConnectorSvcSoap: {
                ...
                authenticate : function(args, callback) {
                    var authReturn = [];
                    authReturn[0] = uuid.v1();
                    if (args.strUserName.trim() === config.username && args.strPassword.trim() === config.password) {
                        ...
                        if ((typeof qbXMLHandler.fetchRequests === "function")) {
                            qbXMLHandler.fetchRequests(function(err, requests) {
                                ...
                                if (err || requestQueue.length === 0) {
                                    ...
                                    authReturn[1] =config.company_file;
                                }
                                callback({
                                    authenticateResult: {'string': [authReturn[0], authReturn[1]]}
                                });
                        ...
                        if ((typeof qbXMLHandler.fetchRequests === "function")) {
                           qbXMLHandler.didReceiveError("Invalid username or password",config.userId,rescallback);
                        }
                ...
                receiveResponseXML : function(args, callback) {
                    ...
                    if (hresult) {
                        ...
                        if ((typeof qbXMLHandler.didReceiveError === "function")) {
                            qbXMLHandler.didReceiveError(hresult,config.userId,rescallback);
                        }
                    } else {
                        if ((typeof qbXMLHandler.handleResponse === "function")) {
                            qbXMLHandler.handleResponse(config.userId, response,true, rescallback);
                        }
                        percentage = (!requestQueue.length) ? 100 : counter * 100 / requestQueue.length;
                        if (percentage >= 100) {
                            // There are no more requests.
                ...
                connectionError : function(args, callback) {
                    console.log("QB CONNECTION ERROR: " + args.message + ' (' + args.hresult + ')');
                    lastError = args.message;
                    var retVal = 'DONE';
                    if ((typeof qbXMLHandler.fetchRequests === "function")) {
                        qbXMLHandler.didReceiveError("QB CONNECTION ERROR2: " + args.message + ' (' + args.hresult + ')',config.userId,rescallback);
                     }
                    callback({
                        connectionErrorResult: { 'string': retVal }
                    });
                ...
                getLastError : function(args, callback) {
                    console.log("GETLAST ERROR")
                    var retVal = this.lastError;
    ...
    if(config) {
        ...
        this.companyFile = config.company_file;
...
//     }
// };
// WebServiceServer.prototype.serverVersion = webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.serverVersion